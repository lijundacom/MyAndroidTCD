...
//	MCineBuffer::SetActiveIndex(0);
	...
	if (nRet)
	{
        LOGE("ERROR: Failed create MSignalProcessThread");
	...
	if (nRet)
	{
        LOGE("ERROR: Failed create MImageProcessThread");
		//printf( "ERROR: Failed create MImageProcessThread\N");
		return false;
	}
	usleep(10000);
